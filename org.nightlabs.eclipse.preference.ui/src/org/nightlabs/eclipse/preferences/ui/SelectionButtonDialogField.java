...
public class SelectionButtonDialogField extends DialogField {
	 ...
	 * @param dialogField The dialog field
	 */
	 ...
	 * @param editor the field
	 * @return <code>true</code> if the given field is attached to the selection button.
	 */
	 ...
	 * after.
	 * @return the selection button widget
	 */		
