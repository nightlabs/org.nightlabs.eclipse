...
public class DialogField {
	 ...
	 * @param display The display to set the focus on
	 */	
	...
	/**
	 * Get a GridData instance for a label.
	 ...
	 * @param parent The parent composite
	 * @return The empty space control
	 */
	 ...
	 * @return <code>true</code> if the control is not <code>null</code>
	 * 		and not disposed
	 */
	 ...
	 * @return <code>true</code> if the dialog field is enabled
	 */	
	...
	/**
	 * Assert that the given composite is not <code>null</code>.
	...
	/**
	 * Assert that the given composite has enough columns.
	 * @param nColumns the number of columns
	 */
