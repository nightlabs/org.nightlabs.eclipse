...
extends ResizableTrayDialog
{
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		nameLabel.setText(Messages.getString("org.nightlabs.editor2d.ui.dialog.CreateTextDialog.name")); //$NON-NLS-1$
		...
		boldButton.setText(Messages.getString("org.nightlabs.editor2d.ui.dialog.CreateTextDialog.bold")); //$NON-NLS-1$
		italicButton = new Button(detailComp, SWT.TOGGLE);
		italicButton.setText(Messages.getString("org.nightlabs.editor2d.ui.dialog.CreateTextDialog.italic")); //$NON-NLS-1$
