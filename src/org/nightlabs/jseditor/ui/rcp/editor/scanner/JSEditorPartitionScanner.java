package org.nightlabs.jseditor.ui.rcp.editor.scanner;
...
/**
 * This scanner recognizes the JSDoc comments and JS multi line comments.
 */
public class JSEditorPartitionScanner extends RuleBasedPartitionScanner {
	 ...
	 */
	public JSEditorPartitionScanner() {
		super();

		IToken javaDoc= new Token(JS_DOC);
		IToken comment= new Token(JS_MULTILINE_COMMENT);
