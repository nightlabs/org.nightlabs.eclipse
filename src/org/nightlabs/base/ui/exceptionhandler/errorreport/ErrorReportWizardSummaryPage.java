...
public class ErrorReportWizardSummaryPage extends DynamicPathWizardPage
{
  protected Text overviewText;
	...
	{
		super(ErrorReportWizardCommentPage.class.getName(), Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardSummaryPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardSummaryPage.description")); //$NON-NLS-1$
	}
