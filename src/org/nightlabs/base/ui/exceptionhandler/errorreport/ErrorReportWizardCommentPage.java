...
public class ErrorReportWizardCommentPage extends DynamicPathWizardPage
{
	...
	{
		super(ErrorReportWizardCommentPage.class.getName(), Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardCommentPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardCommentPage.description")); //$NON-NLS-1$
	}
...
//    page.setLayout(layout);
    ...
    commentLabel.setText(Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardCommentPage.commentLabel.text")); //$NON-NLS-1$
		textUserComment = new Text(page, SWT.BORDER | SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWT.WRAP);
		textUserComment.setToolTipText(Messages.getString("org.nightlabs.base.ui.exceptionhandler.errorreport.ErrorReportWizardCommentPage.textUserComment.toolTipText")); //$NON-NLS-1$
