...
//						return error.getThrownException().getClass().getName();
	...
	{
		(new TableColumn(table, SWT.LEFT)).setText(Messages.getString("org.nightlabs.base.ui.exceptionhandler.ErrorTable.tableColumnExceptionClass")); //$NON-NLS-1$
		(new TableColumn(table, SWT.LEFT)).setText(Messages.getString("org.nightlabs.base.ui.exceptionhandler.ErrorTable.tableColumnMessage")); //$NON-NLS-1$
