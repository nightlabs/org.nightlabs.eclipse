...
//		setMessage("Configure the time pattern for a daily execution.");
	...
	public Control createPageContents(Composite parent) {
		...
		typeDaily.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.typeDaily.text")); //$NON-NLS-1$
		...
		typeChooseDays.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.typeChooseDays.text")); //$NON-NLS-1$
		...
		chooseSun.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseSun.text")); //$NON-NLS-1$
		chooseMon = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseMon.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseMon.text")); //$NON-NLS-1$
		chooseTue = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseTue.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseTue.text")); //$NON-NLS-1$
		chooseWed = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseWed.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseWed.text")); //$NON-NLS-1$
		chooseThu = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseThu.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseThu.text")); //$NON-NLS-1$
		chooseFri = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseFri.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseFri.text")); //$NON-NLS-1$
		chooseSat = new Button(chooseDaysWrapper, SWT.CHECK);
		chooseSat.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.chooseSat.text")); //$NON-NLS-1$

		typeEachXDay = new Button(typeWrapper, SWT.RADIO);
		typeEachXDay.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.typeEachXDays.text")); //$NON-NLS-1$
		...
		eachXDayLabel_beforeSpinner.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.eachXDayLabel_beforeSpinner.text")); //$NON-NLS-1$
		...
		eachXDayLabel_afterSpinner.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.DailyTimePatternBuilderHopPage.eachXDayLabel_afterSpinner.text")); //$NON-NLS-1$
