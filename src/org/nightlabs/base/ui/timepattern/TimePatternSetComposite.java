...
implements TimePatternSetEdit
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnYear")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnMonth")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnDay")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnDayOfWeek")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnHour")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.base.ui.timepattern.TimePatternSetComposite.tableColumnMinute")); //$NON-NLS-1$
