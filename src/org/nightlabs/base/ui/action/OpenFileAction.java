...
import org.nightlabs.base.ui.editor.EditorFileFilterRegistry;
	...
	public void run() 
	{
		...
		try {
			...
			RCPUtil.showErrorDialog(
					String.format(Messages.getString("org.nightlabs.base.ui.action.OpenFileAction.errorOpeningFileFailed"), new Object[] { fullFileName }) //$NON-NLS-1$
			);
		}
	}
