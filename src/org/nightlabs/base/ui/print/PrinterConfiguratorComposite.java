...
//	private Label printerName;
	...
	protected void initGUI(Composite parent)
	{
		...
		printerGroup.setText(Messages.getString("org.nightlabs.base.ui.print.PrinterConfiguratorComposite.printerGroup.text")); //$NON-NLS-1$
		...
		useSysDefaultPrinter.setText(Messages.getString("org.nightlabs.base.ui.print.PrinterConfiguratorComposite.useSysDefaultPrinter.text")); //$NON-NLS-1$
		...
		pageFormatGroup.setText(Messages.getString("org.nightlabs.base.ui.print.PrinterConfiguratorComposite.pageFormatGroup.text")); //$NON-NLS-1$
...
//			printerName.setText(NLBasePlugin.getResourceString("dialog.printerConfiguration.default.noPrinterAssigned"));
	...
	private String getPageFormatDescription(PageFormat pageFormat) {
		if (pageFormat == null)
			return Messages.getString("org.nightlabs.base.ui.print.PrinterConfiguratorComposite.pageFormatDescription_noPageFormatAssigned"); //$NON-NLS-1$
		else
			return Messages.getString("org.nightlabs.base.ui.print.PrinterConfiguratorComposite.pageFormatDescription_customPageFormat"); //$NON-NLS-1$
	}
