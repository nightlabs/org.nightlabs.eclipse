		...
		extends XComposite
{
	...
	private String text = Messages.getString("org.nightlabs.base.ui.composite.CountdownButton.defaultText"); //$NON-NLS-1$
	...
	public CountdownButton(Composite parent, int style, int countdownLengthSec)
	{
		...
		setText(Messages.getString("org.nightlabs.base.ui.composite.CountdownButton.defaultText")); //$NON-NLS-1$
	...
	private String textFormat = Messages.getString("org.nightlabs.base.ui.composite.CountdownButton.defaultTextFormat"); //$NON-NLS-1$
