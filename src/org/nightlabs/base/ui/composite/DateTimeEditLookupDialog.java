		...
		extends Dialog
{
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		if ((DateFormatProvider.DATE & dateTimeEdit.getFlags()) == DateFormatProvider.DATE) {
			...
			new Label(dateComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.yearLabel.text")); //$NON-NLS-1$
			new Label(dateComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.monthLabel.text")); //$NON-NLS-1$
			new Label(dateComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.dayLabel.text")); //$NON-NLS-1$
		...
		if ((DateFormatProvider.TIME & dateTimeEdit.getFlags()) == DateFormatProvider.TIME) {
			...
			new Label(timeComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.hourLabel.text")); //$NON-NLS-1$
			new Label(timeComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.minuteLabel.text")); //$NON-NLS-1$

			if ((DateFormatProvider.TIME_SEC & dateTimeEdit.getFlags()) == DateFormatProvider.TIME_SEC)
				new Label(timeComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.secondLabel.text")); //$NON-NLS-1$

			if ((DateFormatProvider.TIME_MSEC & dateTimeEdit.getFlags()) == DateFormatProvider.TIME_MSEC)
				new Label(timeComp, SWT.NONE).setText(Messages.getString("org.nightlabs.base.ui.composite.DateTimeEditLookupDialog.millisecLabel.text")); //$NON-NLS-1$
