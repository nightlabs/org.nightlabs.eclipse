...
public class PreferencesAccess {
	...
	/**
	 * Get working copy preferences
	 * @param workingCopyManager The working copy manager
	 * @return working copy preferences
	 */
	...
	/**
	 * Get the instance scope.
	 * @return the instance scope.
	 */
	 ...
	 * @param project The project for the scope
