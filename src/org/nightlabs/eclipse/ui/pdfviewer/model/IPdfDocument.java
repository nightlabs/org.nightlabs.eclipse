 ...
 * in the viewing area. Therefore, an object of this interface declares a so-called "real"
 * coordinate system of the complete viewing area including each page's position and bounds.
 * <p>
 * Implementors are free in how they layout their document. Pages can be simply horizontally
 * (or vertically) spread in one row (or column) like it is done by {@link PdfDocument} or
...
public interface IPdfDocument {
	 ...
	 * because it is guaranteed that no other method of the <code>IPdfDocument</code> is called
