...
import org.nightlabs.editor2d.ui.handle.RotateHandleKit;
import org.nightlabs.editor2d.ui.handle.ShapeEditHandleKit;
...
//  	Point moveDelta = request.getMoveDelta();
  	...
  	if (sizeDelta.equals(EMPTY_DIMENSION)) {
    	...
    	String y = Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentResizeEditPolicy.y"); //$NON-NLS-1$
    	...
    	String width = Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentResizeEditPolicy.shortWidth"); //$NON-NLS-1$
    	String height = Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentResizeEditPolicy.shortHeight"); //$NON-NLS-1$
