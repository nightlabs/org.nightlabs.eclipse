...
import org.nightlabs.editor2d.ui.command.ChangeGuideCommand;
...
import org.nightlabs.editor2d.ui.command.CreateTextCommand;
...
import org.nightlabs.editor2d.ui.request.EditorLocationRequest;
...
import org.nightlabs.editor2d.ui.request.LineCreateRequest;
...
//		add.setDebugLabel("MLDC_XYEP add drawComponent");//$NON-NLS-1$
		...
		setConstraint.setLabel(Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentContainerXYLayoutPolicy.command.label.addObject")); //$NON-NLS-1$
...
//  	Rectangle feedbackBounds = getSizeOnDropFeedback().getBounds();
  ...
  protected String getText(CreateRequest request)
  {
  	...
  	String width = Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentContainerXYLayoutPolicy.label.shortWidth"); //$NON-NLS-1$
  	String height = Messages.getString("org.nightlabs.editor2d.ui.editpolicy.DrawComponentContainerXYLayoutPolicy.label.shortHeight"); //$NON-NLS-1$
