...
//		}
		if (ImageDrawComponent.class.isAssignableFrom(c)) {
			return Messages.getString("org.nightlabs.editor2d.ui.util.EditorNameProvider.image"); //$NON-NLS-1$
		}
		else if (RectangleDrawComponent.class.isAssignableFrom(c)) {
			return Messages.getString("org.nightlabs.editor2d.ui.util.EditorNameProvider.rectangle"); //$NON-NLS-1$
		}
			...
			return Messages.getString("org.nightlabs.editor2d.ui.util.EditorNameProvider.text"); //$NON-NLS-1$
		}
