...
import org.nightlabs.editor2d.ui.command.CreateLayerCommand;
import org.nightlabs.editor2d.ui.command.DeleteLayerCommand;
  ...
  protected void createLayerEntry(Composite parent, Layer l)
	{
		...
		if (!parentComposite.isDisposed())
		{
			...
			if (l.isVisible()) {
				...
				buttonVisible.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.invisible.tooltip"));				 //$NON-NLS-1$
			}
			else {
				buttonVisible.setImage(EYE_INVISIBLE_ICON);
				buttonVisible.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.visible.tooltip"));				 //$NON-NLS-1$
			}
...
//		toolsComposite.setBackground(getToolkit().getBackground());
		...
		// create Buttons
		buttonUp = getToolkit().createButton(toolsComposite, Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.up.text"),  //$NON-NLS-1$
				buttonStyle);
//		buttonUp.setImage(UP_ICON);
		buttonUp.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.up.tooltip")); //$NON-NLS-1$
		buttonUp.addSelectionListener(upListener);
		
		buttonDown = getToolkit().createButton(toolsComposite, Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.down.text"),  //$NON-NLS-1$
				buttonStyle);
//		buttonDown.setImage(DOWN_ICON);
		buttonDown.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.down.tooltip")); //$NON-NLS-1$
		buttonDown.addSelectionListener(downListener);
		
		buttonNew = getToolkit().createButton(toolsComposite, Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.new.text"),  //$NON-NLS-1$
				buttonStyle);
//		buttonNew.setImage(NEW_ICON);
		buttonNew.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.new.tooltip"));		 //$NON-NLS-1$
		buttonNew.addSelectionListener(newListener);
		
		buttonDelete = getToolkit().createButton(toolsComposite, Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.delete.text"),  //$NON-NLS-1$
				buttonStyle);
//		buttonDelete.setImage(DELETE_ICON);
		buttonDelete.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.delete.tooltip"));				 //$NON-NLS-1$
		...
		public void widgetSelected(SelectionEvent e)
		{
			...
			if (button2Layer.containsKey(b)) {
				...
				if (!b.getSelection()) {
					l.setVisible(true);
					b.setImage(EYE_ICON);
					b.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.invisible.tooltip")); //$NON-NLS-1$
				} else {
					l.setVisible(false);
					b.setImage(EYE_INVISIBLE_ICON);
					b.setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.views.LayerView.button.visible.tooltip")); //$NON-NLS-1$
				}
				updateViewer();
			}
			else {
