...
import org.nightlabs.editor2d.ui.actions.RepaintRetargetAction;
...
import org.nightlabs.editor2d.ui.actions.zoom.ZoomAllRetargetAction;
import org.nightlabs.editor2d.ui.actions.zoom.ZoomPageAction;
import org.nightlabs.editor2d.ui.actions.zoom.ZoomPageRetargetAction;
import org.nightlabs.editor2d.ui.actions.zoom.ZoomSelectionAction;
import org.nightlabs.editor2d.ui.actions.zoom.ZoomSelectionRetargetSelection;
import org.nightlabs.editor2d.ui.custom.EditorZoomComboContributionItem;
...
//  	addRetargetAction(new DeleteRetargetAction());
  	...
  	addRetargetAction(new RetargetAction(GroupAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.group"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(UnGroupAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.ungroup"))); //$NON-NLS-1$
  	...
  	addRetargetAction(new RetargetAction(ChangeOrderToLocalFront.ID,
  		Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.bringToFront"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ChangeOrderOneUp.ID,
    	Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.moveOneUp"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ChangeOrderOneDown.ID,
    	Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.moveOneDown"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ChangeOrderToLocalBack.ID,
    	Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.bringToBack"))); //$NON-NLS-1$
...
//  			"PrintPreview"));
  	...
  	addRetargetAction(new RetargetAction(ConvertToShapeAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.convertToShape"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(EditShapeAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.editShape"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ShapeUnionAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.shape.union"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ShapeSubtractAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.shape.subtract"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ShapeIntersectAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.shape.intersect"))); //$NON-NLS-1$
  	addRetargetAction(new RetargetAction(ShapeExclusiveOrAction.ID,
  			Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.shape.exclusiveOr")));  	 //$NON-NLS-1$
  }
  ...
  public static final String ID_SHAPE_MENU = Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.menu.shape"); //$NON-NLS-1$
...
//  		fileMenu.insertAfter(EditorPrintPreviewAction.ID, getAction(EditorPrintSetupAction.ID));
  	...
  	// Edit
  	editMenu = new MenuManager(Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.menu.edit"), ID_EDIT_MENU); //$NON-NLS-1$
...
//  	viewMenu.add(getAction(GEFActionConstants.TOGGLE_GRID_VISIBILITY));
  	...
  	// Shape
  	shapeMenu = new MenuManager(Messages.getString("org.nightlabs.editor2d.ui.EditorActionBarContributor.submenu.shape"), ID_SHAPE_MENU); //$NON-NLS-1$
