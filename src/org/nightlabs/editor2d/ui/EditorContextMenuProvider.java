...
import org.nightlabs.editor2d.ui.actions.order.SendToLayerAction;
...
//  		manager.appendToGroup(GEFActionConstants.GROUP_EDIT, action);
  	...
  	// Alignment SubMenu
  	MenuManager alignSubMenu = new MenuManager(Messages.getString("org.nightlabs.editor2d.ui.EditorContextMenuProvider.menu.align")); //$NON-NLS-1$
