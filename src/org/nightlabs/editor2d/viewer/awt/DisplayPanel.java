...
import org.nightlabs.editor2d.viewer.IBufferedViewport;
import org.nightlabs.editor2d.viewer.ICanvas;
import org.nightlabs.editor2d.viewer.ITempContentManager;
import org.nightlabs.editor2d.viewer.TempContentManager;
...
//		int newY = (int) Math.floor(initRealBounds.y * scale);
	...
	/**
	 * @see org.nightlabs.editor2d.viewer.IViewport#getViewLocation()
	 */
