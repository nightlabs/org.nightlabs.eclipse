...
extends ZoomAction
{
	...
	{
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomInAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomInAction.tooltip")); //$NON-NLS-1$
