...
extends ZoomAction 
{
	...
	{
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomAllAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomAllAction.tooltip")); //$NON-NLS-1$
