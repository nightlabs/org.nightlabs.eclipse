...
extends XContributionItem
{
  ...
  protected Control createControl(Composite parent) 
  {
  	...
  	showString.setText(Messages.getString("org.nightlabs.editor2d.viewer.action.RenderModeContributionItem.text.showText")); //$NON-NLS-1$
  	showString.setToolTipText(Messages.getString("org.nightlabs.editor2d.viewer.action.RenderModeContributionItem.tooltip.showText")); //$NON-NLS-1$
  	...
  	showFillColor.setText(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.action.RenderModeContributionItem.text.showFillColor"))); //$NON-NLS-1$
  	showFillColor.setToolTipText(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.action.RenderModeContributionItem.tooltip.showFillColor"))); //$NON-NLS-1$
