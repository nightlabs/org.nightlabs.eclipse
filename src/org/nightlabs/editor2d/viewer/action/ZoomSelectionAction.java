...
import org.nightlabs.editor2d.viewer.event.ISelectionChangedListener;
import org.nightlabs.editor2d.viewer.event.SelectionEvent;
...
extends ZoomAction 
{
	...
	{
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomSelectionAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.viewer.action.ZoomSelectionAction.tooltip")); //$NON-NLS-1$
