...
import org.nightlabs.editor2d.viewer.event.IColorChangedListener;
...
extends AbstractContributionItem 
{
	...
	{
		super(ID, Messages.getString("org.nightlabs.editor2d.viewer.action.BackgroundContributionItem.name")); //$NON-NLS-1$
		this.viewer = viewer;
