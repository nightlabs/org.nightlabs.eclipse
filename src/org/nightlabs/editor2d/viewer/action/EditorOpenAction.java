...
import org.nightlabs.editor2d.viewer.awt.AWTViewerDialog;
...
extends AbstractOpenAction 
{
	...
	{
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.viewer.action.EditorOpenAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.viewer.action.EditorOpenAction.tooltip")); //$NON-NLS-1$
	}
}
