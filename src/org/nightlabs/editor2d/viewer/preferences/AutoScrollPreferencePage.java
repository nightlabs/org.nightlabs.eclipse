...
{	
	public AutoScrollPreferencePage() 
	{
		...
		setTitle(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.AutoScrollPreferencePage.title"))); //$NON-NLS-1$
	}
...
//protected IntegerFieldEditor bufferScale;	
	...
	protected void createFieldEditors()
	{
		scrollStep = new IntegerFieldEditor(Preferences.PREFERENCE_SCROLL_STEP,
				ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.AutoScrollPreferencePage.label.autoScroll")), //$NON-NLS-1$
		...
		scrollTolerance = new IntegerFieldEditor(Preferences.PREFERENCE_SCROLL_TOLERANCE,
				ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.AutoScrollPreferencePage.label.scrollTollerance")), //$NON-NLS-1$
				getFieldEditorParent());
		...
		timerDelay = new IntegerFieldEditor(Preferences.PREFERENCE_TIMER_DELAY,
				ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.AutoScrollPreferencePage.label.timerDelay")), //$NON-NLS-1$
				getFieldEditorParent());
