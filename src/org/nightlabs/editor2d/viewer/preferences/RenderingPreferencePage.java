...
{		
	public RenderingPreferencePage() 
	{
		...
		setTitle(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.RenderingPreferencePage.title"))); //$NON-NLS-1$
	}
...
//	protected Button buttonCustom;
	...
	{		
		...
		labelDefault.setText(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.RenderingPreferencePage.default"))); //$NON-NLS-1$
		...
		labelQuality.setText(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.RenderingPreferencePage.quality"))); //$NON-NLS-1$
		...
		labelSpeed.setText(ViewerPlugin.getResourceString(Messages.getString("org.nightlabs.editor2d.viewer.preferences.RenderingPreferencePage.speed")));		 //$NON-NLS-1$
