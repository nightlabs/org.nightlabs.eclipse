...
package org.nightlabs.editor2d.viewer.app;
...
{
	public static final String PLUGIN_ID = "org.nightlabs.editor2d.viewer"; //$NON-NLS-1$

	public String initApplicationName() {		
		return Messages.getString("org.nightlabs.editor2d.viewer.app.ViewerApplication.application.name"); //$NON-NLS-1$
	}
