...
public class OutOfMemoryErrorDialog extends DefaultErrorDialog {
	...
	protected void createCustomButtons(Composite parent) {
		restartWorkbenchButton = createButton(parent, RESTART_WORKBENCH_ID, Messages.getString("org.nightlabs.base.ui.exceptionhandler.OutOfMemoryErrorDialog.restartWorkbenchButton.text"), false); //$NON-NLS-1$
		// TODO:
